...
class Customize_Categories_Control extends WP_Customize_control {
    ...
    public function render_content() {
        ...
        $dropdown = wp_dropdown_categories(
            array(
                ...
                'echo'              => 0,
                'show_option_none'  => __( '&mdash; Select &mdash;', 'theme-domain' ),
                'option_none_value' => '0',
                'hierarchical'      => 1, 
                'selected'          => $this->value(),
            )
...
class Customize_Menus_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        if( empty( $this->menus ) )
	        ...
	        <label class="customize-control-select">
	            ...
	            <option value=""><?php _e( '&mdash; Select &mdash;', 'double-dou' ); ?></option>
	            <?php 
...
class Customize_Users_Control extends WP_Customize_Control {
...
class Customize_Posts_Control extends WP_Customize_Control {
...
class Customize_Post_Type_Control extends WP_Customize_Control {
...
class Customize_Tags_Control extends WP_Customize_Control {
